...
CREATE TABLE `apijson_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1497792972315 DEFAULT CHARSET=utf8 COMMENT='对安全要求高，不想泄漏真实名称。对外名称为 User';
...
-- Dump completed on 2017-06-18 21:37:26
