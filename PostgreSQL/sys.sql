...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (2, 0, 1, '注册(先获取验证码type:1)', '/register', '{
    ...
    "verify": "6840"
}', '{"code":412,"msg":"手机号或验证码错误！"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (3, 0, 1, '退出登录', '/logout', '{}', null, null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511689914598, 0, 1, '获取用户隐私信息', '/gets', '{"tag": "Privacy", "Privacy": {"id": 82001}}', '{"Privacy":{"id":82001,"more":true,"certified":1,"phone":13000082001,"balance":9835.11},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511796155276, 0, 1, '获取验证码', '/post/verify', '{"type": 0, "phone": "13000082001"}', '{"Verify":{"id":1533396718012,"type":0,"phone":13000082001,"verify":4995,"date":"2018-08-04 23:31:58.0"},"tag":"Verify","code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511796208669, 0, 1, '检查验证码是否存在', '/heads/verify', '{"type": 0, "phone": "13000082001"}', '{"Verify":{"code":200,"msg":"success","count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511796589078, 0, 1, '修改登录密码(先获取验证码type:2)-手机号+验证码', '/put/password', '{"verify": "10322", "Privacy": {"phone": "13000082001", "_password": "666666"}}', '{"code":412,"msg":"手机号或验证码错误！"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511796882183, 0, 1, '充值(需要支付密码)/提现', '/put/balance', '{"tag": "Privacy", "Privacy": {"id": 82001, "balance+": 100.15, "_payPassword": "123456"}}', '{"Privacy":{"code":200,"msg":"success","id":82001,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511963330794, 0, 2, '获取文档列表(即在线解析网页上的共享)-API调用方式', '/get', '{
    "Document[]": {
        "Document": {
            "@role": "login",
            "@order": "version-,date-"
...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511963677324, 0, 1, '获取用户', '/get', '{"User": {"id": 82001}}', '{"User":{"id":82001,"sex":0,"name":"测试改名","tag":"APIJSON User","head":"https://static.oschina.net/uploads/user/19/39085_50.jpg","contactIdList":[82025,82024,82003,93793,70793],"pictureList":["http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511963722969, 0, 1, '获取用户列表("id{}":contactIdList)-朋友页', '/get', '{
    "User[]": {
        "count": 10,
        "page": 0,
        "User": {
...
}', '{"Moment":{"id":15,"userId":70793,"date":"2017-02-08 16:06:11.0","content":"APIJSON is a JSON Transmission Structure Protocol…","praiseUserIdList":[82055,82002,38710],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"]},"User":{"id":70793,"name":"Strong","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000"},"User[]":[{"id":38710,"name":"TommyLemon"},{"id":82002,"name":"Happy~"},{"id":82055,"name":"Solid"}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511964176688, 0, 1, '获取评论列表-动态详情页Comment+User', '/get', '{
    "[]": {
        "count": 20,
        "page": 0,
        "Comment": {
...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511969417632, 0, 1, '点赞/取消点赞', '/put', '{
    ...
    "tag": "Moment"
}', '{"Moment":{"code":200,"msg":"success","id":15,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511969630371, 0, 1, '新增评论', '/post', '{     "Comment": {         "momentId": 15,         "content": "测试新增评论"     },     "tag": "Comment" }', '{"Comment":{"code":200,"msg":"success","id":1533140610714,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511970009071, 0, 1, '新增动态', '/post', '{     "Moment": {         "content": "测试新增动态",         "pictureList": ["http://static.oschina.net/uploads/user/48/96331_50.jpg"         ]     },     "tag": "Moment" }', '{"Moment":{"code":200,"msg":"success","id":1533140610716,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1511970224332, 0, 1, '修改用户信息', '/put', '{
     "User": {
         "id": 82001,
         "name": "测试账号"
     },
     "tag": "User"
 }', '{"User":{"code":200,"msg":"success","id":82001,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1512216131854, 0, 1, '获取文档列表(即在线解析网页上的文档)-表和字段、请求格式限制', '/get', '{
    "[]": {
        "Table": {
            "TABLE_SCHEMA": "sys",
...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521901518764, 0, 2, '功能符(对象关键词): ⑤从pictureList获取第0张图片：', '/get', '{     "User": {         "id": 38710,         "@position": 0,         "firstPicture()": "getFromArray(pictureList,@position)"     } }', '{"User":{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0","@position":0,"firstPicture":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000"},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521901610783, 0, 2, '功能符(对象关键词): ④查询 按userId分组、id最大值>=100 的Moment数组', '/get', '{"[]":{"count":10,"Moment":{"@column":"userId;max(id):maxId","@group":"userId","@having":"maxId>=100"}}}', '{"[]":[{"Moment":{"userId":38710,"maxId":1537025707417}},{"Moment":{"userId":70793,"maxId":551}},{"Moment":{"userId":82001,"maxId":1537025634931}},{"Moment":{"userId":82002,"maxId":1531062713966}},{"Moment":{"userId":82003,"maxId":1536805585275}},{"Moment":{"userId":82045,"maxId":1508073178489}},{"Moment":{"userId":82056,"maxId":1514858533480}},{"Moment":{"userId":93793,"maxId":1516086423441}},{"Moment":{"userId":1520242280259,"maxId":1520242333325}},{"Moment":{"userId":1523626157302,"maxId":1523936332614}}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521901682845, 0, 2, '功能符(对象关键词): ③查询按userId分组的Moment数组', '/get', '{"[]":{"count":10,"Moment":{"@column":"userId,id","@group":"userId,id"}}}', '{"[]":[{"Moment":{"userId":38710,"id":235}},{"Moment":{"userId":38710,"id":470}},{"Moment":{"userId":38710,"id":511}},{"Moment":{"userId":38710,"id":595}},{"Moment":{"userId":38710,"id":704}},{"Moment":{"userId":38710,"id":1491200468898}},{"Moment":{"userId":38710,"id":1493835799335}},{"Moment":{"userId":38710,"id":1512314438990}},{"Moment":{"userId":38710,"id":1513094436910}},{"Moment":{"userId":38710,"id":1537025625613}}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521901746808, 0, 2, '功能符(对象关键词): ②查询按 name降序、id默认顺序 排序的User数组', '/get', '{"[]":{"count":10,"User":{"@column":"name,id","@order":"name-,id"}}}', '{"[]":[{"User":{"name":"赵钱孙李","id":1508072071492}},{"User":{"name":"测试改名","id":82001}},{"User":{"name":"梦","id":1528264711016}},{"User":{"name":"宁旭","id":1532188114543}},{"User":{"name":"四五六","id":1508072160401}},{"User":{"name":"哈哈哈","id":1524042900591}},{"User":{"name":"周吴郑王","id":1508072105320}},{"User":{"name":"七八九十","id":1508072202871}},{"User":{"name":"一二三","id":1499057230629}},{"User":{"name":"Yong","id":82027}}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521901787202, 0, 2, '功能符(对象关键词): ①只查询id,sex,name这几列并且请求结果也按照这个顺序', '/get', '{"User":{"@column":"id,sex,name","id":38710}}', '{"User":{"id":38710,"sex":0,"name":"TommyLemon"},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521902033331, 0, 2, '功能符(数组关键词): ③查询User数组和对应的User总数', '/get', '{"[]":{"query":2,"count":5,"User":{}},"total@":"/[]/total"}', '{"[]":[{"User":{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":70793,"sex":0,"name":"Strong","tag":"djdj","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000","contactIdList":[38710,82002],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_eGDi.jpg","http://static.oschina.net/uploads/img/201604/22172507_rrZ5.jpg","https://camo.githubusercontent.com/788c0a7e11a","https://camo.githubusercontent.com/f513f67"],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82001,"sex":0,"name":"测试改名","tag":"APIJSON User","head":"https://static.oschina.net/uploads/user/19/39085_50.jpg","contactIdList":[82025,82024,82003,93793,82012,82028,82021,82006,82030,82035],"pictureList":["http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82002,"sex":1,"name":"Happy~","tag":"iOS","head":"http://static.oschina.net/uploads/user/1174/2348263_50.png?t=1439773471000","contactIdList":[82005,82001,38710],"pictureList":[],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82003,"sex":1,"name":"Wechat","head":"http://common.cnblogs.com/images/wechat.png","contactIdList":[82001,93793],"pictureList":[],"date":"2017-02-01 19:21:50.0"}}],"total":121,"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521902069870, 0, 2, '功能符(数组关键词): ②查询第3页的User数组，每页5个', '/get', '{"[]":{"count":5,"page":3,"User":{}}}', '{"[]":[{"User":{"id":82025,"sex":1,"name":"Tommy","head":"http://static.oschina.net/uploads/user/629/1258821_50.jpg?t=1378063141000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82026,"sex":0,"name":"iOS","head":"http://static.oschina.net/uploads/user/1200/2400261_50.png?t=1439638750000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82027,"sex":0,"name":"Yong","head":"http://my.oschina.net/img/portrait.gif?t=1451961935000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82028,"sex":1,"name":"gaeg","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82029,"sex":0,"name":"GASG","head":"http://common.cnblogs.com/images/wechat.png","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521902110679, 0, 2, '功能符(数组关键词): ①查询User数组，最多5个', '/get', '{"[]":{"count":5,"User":{}}}', '{"[]":[{"User":{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":70793,"sex":0,"name":"Strong","tag":"djdj","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000","contactIdList":[38710,82002],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_eGDi.jpg","http://static.oschina.net/uploads/img/201604/22172507_rrZ5.jpg","https://camo.githubusercontent.com/788c0a7e11a","https://camo.githubusercontent.com/f513f67"],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82001,"sex":0,"name":"测试改名","tag":"APIJSON User","head":"https://static.oschina.net/uploads/user/19/39085_50.jpg","contactIdList":[82025,82024,82003,93793,82012,82028,82021,82006,82030,82035],"pictureList":["http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82002,"sex":1,"name":"Happy~","tag":"iOS","head":"http://static.oschina.net/uploads/user/1174/2348263_50.png?t=1439773471000","contactIdList":[82005,82001,38710],"pictureList":[],"date":"2017-02-01 19:21:50.0"}},{"User":{"id":82003,"sex":1,"name":"Wechat","head":"http://common.cnblogs.com/images/wechat.png","contactIdList":[82001,93793],"pictureList":[],"date":"2017-02-01 19:21:50.0"}}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521903761688, 0, 2, '功能符(逻辑运算): ③ ! 非运算', '/head', '{"User":{"id!{}":[82001,38710]}}', '{"User":{"code":200,"msg":"success","count":119},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521903828409, 0, 2, '功能符(逻辑运算): ② | 或运算', '/head', '{"User":{"id|{}":">90000,<=80000"}}', '{"User":{"code":200,"msg":"success","count":72},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521903882829, 0, 2, '功能符(逻辑运算): ① & 与运算', '/head', '{"User":{"id&{}":">80000,<=90000"}}', '{"User":{"code":200,"msg":"success","count":49},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904098110, 0, 2, '功能符: 减少 或 去除', '/put/balance', '{
...
}', '{"Privacy":{"code":200,"msg":"success","id":82001,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904162065, 0, 2, '功能符: 增加 或 扩展', '/put', '{
    "Moment": {
        "id": 15,
        "praiseUserIdList+": [
            82001
...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904337053, 0, 2, '功能符: 新建别名', '/get', '{"Comment":{"@column":"id,toId:parentId","id":51}}', '{"Comment":{"id":51,"parentId":45},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904394041, 0, 2, '功能符: 正则匹配', '/get', '{"User[]":{"count":3,"User":{"name?":"^[0-9]+$"}}}', '{"User[]":[{"id":90814,"sex":0,"name":"007","head":"http://static.oschina.net/uploads/user/51/102723_50.jpg?t=1449212504000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"},{"id":1528339692804,"sex":1,"name":"568599","head":"http://my.oschina.net/img/portrait.gif?t=1451961935000","contactIdList":[1528250827953,1528264711016],"date":"2018-06-07 10:48:12.0"}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904437583, 0, 2, '功能符: 模糊搜索', '/get', '{"User[]":{"count":3,"User":{"name$":"%m%"}}}', '{"User[]":[{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},{"id":82004,"sex":0,"name":"Tommy","tag":"fasef","head":"http://static.oschina.net/uploads/user/1200/2400261_50.png?t=1439638750000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"},{"id":82006,"sex":1,"name":"Meria","head":"http://static.oschina.net/uploads/user/998/1997902_50.jpg?t=1407806577000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904653621, 0, 2, '功能符: 包含选项范围', '/get', '{"User[]":{"count":3,"User":{"contactIdList<>":38710}}}', '{"User[]":[{"id":70793,"sex":0,"name":"Strong","tag":"djdj","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000","contactIdList":[38710,82002],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_eGDi.jpg","http://static.oschina.net/uploads/img/201604/22172507_rrZ5.jpg","https://camo.githubusercontent.com/788c0a7e11a","https://camo.githubusercontent.com/f513f67"],"date":"2017-02-01 19:21:50.0"},{"id":82002,"sex":1,"name":"Happy~","tag":"iOS","head":"http://static.oschina.net/uploads/user/1174/2348263_50.png?t=1439773471000","contactIdList":[82005,82001,38710],"pictureList":[],"date":"2017-02-01 19:21:50.0"},{"id":82005,"sex":1,"name":"Jan","tag":"AG","head":"http://my.oschina.net/img/portrait.gif?t=1451961935000","contactIdList":[82001,38710,1532439021068],"pictureList":[],"date":"2017-02-01 19:21:50.0"}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904698934, 0, 2, '功能符: 匹配条件范围', '/get', '{"User[]":{"count":3,"User":{"id{}":"<=80000,>90000"}}}', '{"User[]":[{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},{"id":70793,"sex":0,"name":"Strong","tag":"djdj","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000","contactIdList":[38710,82002],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_eGDi.jpg","http://static.oschina.net/uploads/img/201604/22172507_rrZ5.jpg","https://camo.githubusercontent.com/788c0a7e11a","https://camo.githubusercontent.com/f513f67"],"date":"2017-02-01 19:21:50.0"},{"id":90814,"sex":0,"name":"007","head":"http://static.oschina.net/uploads/user/51/102723_50.jpg?t=1449212504000","contactIdList":[],"pictureList":[],"date":"2017-02-01 19:21:50.0"}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521904756673, 0, 2, '功能符: 查询数组', '/get', '{"User[]":{"count":3,"User":{}}}', '{"User[]":[{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},{"id":70793,"sex":0,"name":"Strong","tag":"djdj","head":"http://static.oschina.net/uploads/user/585/1170143_50.jpg?t=1390226446000","contactIdList":[38710,82002],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_eGDi.jpg","http://static.oschina.net/uploads/img/201604/22172507_rrZ5.jpg","https://camo.githubusercontent.com/788c0a7e11a","https://camo.githubusercontent.com/f513f67"],"date":"2017-02-01 19:21:50.0"},{"id":82001,"sex":0,"name":"测试改名","tag":"APIJSON User","head":"https://static.oschina.net/uploads/user/19/39085_50.jpg","contactIdList":[82025,82024,82003,93793],"pictureList":["http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"}],"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905263827, 0, 2, '操作方法(DELETE):  删除数据', '/delete', '{
   "Moment":{
     "id":120
   },
   "tag":"Moment"
}', '{"Moment":{"code":404,"msg":"可能对象不存在！","id":120,"count":0},"Comment":{"code":404,"msg":"可能对象不存在！","count":0},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905599149, 0, 2, '操作方法(PUT):  修改数据，只修改所传的字段', '/put', '{
   "Moment":{
     "id":235,
     "content":"APIJSON,let interfaces and documents go to hell !"
   },
   "tag":"Moment"
}', '{"Moment":{"code":200,"msg":"success","id":235,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905680679, 0, 2, '操作方法(POST):  新增数据', '/post', '{     "Moment": {         "content": "APIJSON,let interfaces and documents go to hell !"     },     "tag": "Moment" }', '{"Moment":{"code":200,"msg":"success","id":1538112282445,"count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905787849, 0, 2, '操作方法(HEADS):  安全/私密获取数量，用于获取银行卡数量等 对安全性要求高的数据总数', '/heads', '{
    "Login": {
        "userId": 38710,"type":1
    },
    "tag": "Login"
}', '{"Login":{"code":200,"msg":"success","count":1},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905868718, 0, 2, '操作方法(GETS):  安全/私密获取数据，用于获取钱包等 对安全性要求高的数据', '/gets', '{
    "Privacy": {
        "id": 82001
    },
    "tag": "Privacy"
}', '{"Privacy":{"id":82001,"certified":1,"phone":13000082001,"balance":9832.86},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905895590, 0, 2, '操作方法(HEAD):  普通获取数量，可用浏览器调试', '/head', '{
   "Moment":{
     "userId":38710
   }
}', '{"Moment":{"code":200,"msg":"success","count":10},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521905913187, 0, 2, '操作方法(GET):  普通获取数据，可用浏览器调试', '/get', '{
   "Moment":{
     "id":235
   }
}', '{"Moment":{"id":235,"userId":38710,"date":"2017-02-08 16:06:11.0","content":"APIJSON,let interfaces and documents go to hell !","praiseUserIdList":[82001],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_mpwj.jpg","http://static.oschina.net/uploads/user/1332/2664107_50.jpg?t=1457405500000"]},"code":200,"msg":"success"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521906240331, 0, 2, 'User发布的Moment列表，每个Moment包括 1.发布者User 2.前3条Comment: ③不查已获取的User', '/get', '{
   "[]":{
     "page":0,
     "count":3, 
     "Moment":{
...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521906517000, 0, 2, 'User发布的Moment列表，每个Moment包括 1.发布者User 2.前3条Comment: ①指定id', '/get', '{
    "[]": {
        "page": 0,
        "count": 3,
...
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521907009307, 0, 2, 'Moment列表，每个Moment包括 1.发布者User 2.前3条Comment', '/get', '{
   "[]":{
     "page":0, 
     "count":3, 
     "Moment":{}, 
...
}', '{"Moment":{"id":235,"userId":38710,"date":"2017-02-08 16:06:11.0","content":"APIJSON,let interfaces and documents go to hell !","praiseUserIdList":[82001],"pictureList":["http://static.oschina.net/uploads/img/201604/22172508_mpwj.jpg","http://static.oschina.net/uploads/user/1332/2664107_50.jpg?t=1457405500000"]},"User":{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},"code":200,"msg":"success","time:start/duration/end":"1556501639026/16/1556501639042","query:depth/max":"1/5","sql:generate/cache/execute/maxExecute":"2/0/2/200"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521907333044, 0, 2, 'User', '/get', '{
   "User":{
     "id":38710
   }
}', '{"User":{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},"code":200,"msg":"success","time:start/duration/end":"1556501639010/3/1556501639013","query:depth/max":"1/5","sql:generate/cache/execute/maxExecute":"1/0/1/200"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521907333046, 0, 2, 'Moment INNER JOIN User LEFT JOIN Comment', '/get', '{
    "[]": {
        "count": 10,
        "page": 0,
...
}', '{"[]":[{"User":{"id":38710,"name":"TommyLemon"}},{"User":{"id":70793,"name":"Strong"}},{"User":{"id":82001,"name":"测试账号"}}],"code":200,"msg":"success","time:start/duration/end":"1556501638960/37/1556501638997","query:depth/max":"3/5","sql:generate/cache/execute/maxExecute":"3/2/1/200"}', null);
INSERT INTO sys."Document" (id, "userId", version, name, url, request, response, date) VALUES (1521907601298, 0, 2, '获取用户', '/get', '{
  "User":{
  }
}', '{"User":{"id":38710,"sex":0,"name":"TommyLemon","tag":"Android&Java","head":"http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","contactIdList":[82003,82005,90814,82004,82009,82002,82044,93793,70793],"pictureList":["http://static.oschina.net/uploads/user/1218/2437072_100.jpg?t=1461076033000","http://common.cnblogs.com/images/icon_weibo_24.png"],"date":"2017-02-01 19:21:50.0"},"code":200,"msg":"success","time:start/duration/end":"1556501638955/17/1556501638972","query:depth/max":"1/5","sql:generate/cache/execute/maxExecute":"1/0/1/200"}', null);
...
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (1, 1, 'POST', 'register', '{"User": {"PUT": {"id@": "Privacy/id"}, "DISALLOW": "id", "NECESSARY": "name"}, "Privacy": {"UNIQUE": "phone", "VERIFY": {"phone?": "phone"}, "DISALLOW": "id", "NECESSARY": "_password,phone"}}', 'UNIQUE校验phone是否已存在。VERIFY校验phone是否符合手机号的格式', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (2, 1, 'POST', 'Moment', '{"ADD": {"@role": "owner", "pictureList": [], "praiseUserIdList": []}, "PUT": {"verifyIdList-()": "verifyIdList(praiseUserIdList)", "verifyURLList-()": "verifyURLList(pictureList)"}, "DISALLOW": "id"}', 'ADD当没传pictureList和praiseUserIdList时用空数组[]补全，保证不会为null', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (3, 1, 'POST', 'Comment', '{"PUT": {"@role": "owner"}, "DISALLOW": "id", "NECESSARY": "momentId,content"}', '必须传userId,momentId,content，不允许传id', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (4, 1, 'PUT', 'User', '{"ADD": {"@role": "owner"}, "DISALLOW": "phone", "NECESSARY": "id"}', '必须传id，不允许传phone。ADD当没传@role时用owner补全', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (5, 1, 'DELETE', 'Moment', '{"Moment": {"ADD": {"@role": "owner"}, "PUT": {"commentCount()": "deleteCommentOfMoment(id)"}, "NECESSARY": "id"}}', null, '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (6, 1, 'DELETE', 'Comment', '{"ADD": {"@role": "owner"}, "PUT": {"childCount()": "deleteChildComment(id)"}, "NECESSARY": "id"}', 'disallow没必要用于DELETE', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (8, 1, 'PUT', 'User-phone', '{"User": {"ADD": {"@role": "owner"}, "PUT": {"@combine": "_password"}, "DISALLOW": "!", "NECESSARY": "id,phone,_password"}}', '! 表示其它所有，这里指necessary所有未包含的字段', '2017-02-01 11:19:51.000000');
...
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (23, 1, 'PUT', 'Privacy', '{"ADD": {"@role": "owner"}, "NECESSARY": "id"}', 'ADD当没传@role时用owner补全', '2017-02-01 11:19:51.000000');
...
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (26, 1, 'DELETE', 'Comment[]', '{"Comment": {"ADD": {"@role": "owner"}, "NECESSARY": "id{}"}}', 'DISALLOW没必要用于DELETE', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (27, 1, 'PUT', 'Comment[]', '{"Comment": {"ADD": {"@role": "owner"}, "NECESSARY": "id{}"}}', 'DISALLOW没必要用于DELETE', '2017-02-01 11:19:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (28, 1, 'PUT', 'Comment', '{"ADD": {"@role": "owner"}, "NECESSARY": "id"}', '这里省略了Comment，因为tag就是Comment，Parser.getCorrectRequest会自动补全', '2017-02-01 11:19:51.000000');
...
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (31, 1, 'PUT', 'balance-', '{"Privacy": {"PUT": {"@combine": "_password"}, "VERIFY": {"balance-&{}": ">=1,<=10000"}, "DISALLOW": "!", "NECESSARY": "id,balance-,_password"}}', 'PUT强制把_password作为WHERE条件', '2017-10-21 08:48:34.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (32, 2, 'GETS', 'Privacy', '{"ADD": {"@role": "owner"}, "DISALLOW": "_password,_payPassword", "NECESSARY": "id"}', null, '2017-06-12 16:05:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (33, 2, 'GETS', 'Privacy-CIRCLE', '{"Privacy": {"PUT": {"@role": "CIRCLE", "@column": "phone"}, "DISALLOW": "!", "NECESSARY": "id"}}', null, '2017-06-12 16:05:51.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (35, 2, 'POST', 'Document', '{"DISALLOW": "id", "NECESSARY": "userId,name,url,request"}', null, '2017-11-26 08:34:41.000000');
...
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (37, 2, 'DELETE', 'Document', '{"ADD": {"@role": "owner"}, "PUT": {"TestRecord": {"@role": "owner", "documentId@": "Document/id"}}, "DISALLOW": "!", "NECESSARY": "id"}', null, '2017-11-26 00:36:20.000000');
