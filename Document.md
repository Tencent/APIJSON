...
------------ | ------------ | ------------
 ...
 匹配条件范围 | "key{}":"条件0,条件1..."，条件为SQL表达式字符串，可进行简单的数学计算 | ["id{}":"<=80000,\>90000"](http://apijson.cn:8080/get/{"User[]":{"count":3,"User":{"id{}":"<=80000,\>90000"}}})，对应SQL是`id<=80000 OR id>90000`，查询id符合id\<=80000 \| id>90000的一个User数组
