...
------------ | ------------ | ------------
 ...
 连续范围 | "key%":"start,end"  =>  "key%":[start, end]，其中 start 和 end 都只能为 Boolean, Number, String 中的一种，如 "10,100" ，["2017-10-01", "2018-10-01"] ，可用于连续范围内的筛选 | ["date%":"2017-10-01,2018-10-01"](http://apijson.cn:8080/get/{"User[]":{"count":3,"User":{"date%2525":"2017-10-01,2018-10-01"}}})，查询在2017-10-01和2018-10-01期间注册的用户的一个User数组
