...
-------- | ------------ | ------------
 ...
 User和对应的Moment | 分两次请求<br />User: http://localhost:8080/get/user?id=1<br />Moment: http://localhost:8080/get/moment?userId=1 | [http://localhost:8080/get/{"Moment":{"id":15}, "User":{"id@":"Moment/id"}}](http://192.168.1.102:8080/get/%7B%22Moment%22%3A%7B%22id%22%3A15%7D%2C%22User%22%3A%7B%22id%40%22%3A%22Moment%252FuserId%22%7D%7D)
 ...
 type为1的Moment列表，每个Moment包括发布者User和前3条Comment | Moment里必须有User的Object和Comment的Array<br /> http://localhost:8080/get/moment/list?page=1&count=5&type=1&commentCount=3 | [http://localhost:8080/get/{"[]":{"page":1, "count":5, "Moment":{"type":1}, "User":{"momentId@":"/Moment/id"}, "[]":{"count":3, "Comment":{"momentId@":"[]/Moment/id"}}}}](http://139.196.140.118:8080/get/{"[]":{"page":1,"count":5,"Moment":{"type":1},"User":{"momentId@":"/Moment/id"},"[]":{"count":3,"Comment":{"momentId@":"[]/Moment/id"}}}})
 1个User发布的Moment列表，每个Moment包括发布者User和前3条Comment | 把以上请求里的type=1改为userId=1 | 有以下几种方法:<br />①把以上请求里的"Moment":{"type":1}, "User":{"momentId@":"/Moment/id"}改为"User":{"id":1}, "Moment":{"userId@":"/User/id"}<br /><br />②或这样省去4条重复User<br />[http://localhost:8080/get/{"User":{"id":1}, "[]":{"page":1, "count":5, "Moment":{"userId@":"User/id"}, "[]":{"count":3, "Comment":{"momentId@":"[]/Moment/id"}}}}](http://139.196.140.118:8080/get/{"User":{"id":1},"[]":{"page":1,"count":5,"Moment":{"userId@":"User/id"},"[]":{"count":3,"Comment":{"momentId@":"[]/Moment/id"}}}})<br /><br />③如果User之前已经获取到了，还可以这样省去所有重复User<br />[http://localhost:8080/get/{"[]":{"page":1, "count":5, "Moment":{"userId":1}, "[]":{"count":3, "Comment":{"momentId@":"[]/Moment/id"}}}}](http://139.196.140.118:8080/get/{"[]":{"page":1,"count":5,"Moment":{"userId":1},"[]":{"count":3,"Comment":{"momentId@":"[]/Moment/id"}}}})
