...
------------ | ------------ | ------------
 ...
 "key<\>":Object -> "key<\>":[Object]，Object为JSONObject,JSONArray之外的类型 | 包含选项范围 | "friendIdList<\>":38710，查询friendIdList包含38710的Object。一般用于查询一个数组。请求[{"[]":{"User":{"friendIdList<\>":38710}}}](http://139.196.140.118:8080/get/{"[]":{"count":3,"User":{"friendIdList<\>":38710}}})会返回一个User数组，例如上面那个
