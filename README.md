...
-------- | ------------ | ------------
 ...
 type为1的Moment列表，每个Moment包括发布者User和前3条Comment | Moment里必须有User的Object和Comment的Array<br /> http://localhost:8080/get/moment/list?page=1&count=5&type=1&commentCount=3 | [http://localhost:8080/get/{"[]":{"page":1, "count":5, "Moment":{"type":1}, "User":{"momentId@":"/Moment/id"}, "[]":{"count":3, "Comment":{"momentId@":"[]/Moment/id"}}}}](http://192.168.1.102:8080/get/{"[]":{"page":1,"count":5,"Moment":{"type":1},"User":{"momentId@":"/Moment/id"},"[]":{"count":3,"Comment":{"momentId@":"[]/Moment/id"}}}})
