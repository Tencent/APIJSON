...
---------- | ------------ | ----------
 ...
 "@key":任意Object | @key为关键字，作用各不相同，但都不作为查询匹配条件 | "@columns":"id,sex,name"，只查询id,sex,name这几个字段；<br />"@count":10，数组长度最大为10；<br />"@page":1，页码为1；<br />"@userId@":"User/id","head":"get(Collection:pictureList,Object:@userId)"，从pictureList获取第一张图片作为头像...
