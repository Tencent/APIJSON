...
------------ | ------------ | ------------
 ...
 "key<\>":Object  =>  "key<\>":[Object]，key对应值的类型必须为JSONArray，Object为JSONObject,JSONArray之外的类型 | 包含选项范围 | [{"[]":{"User":{"friendIdList<\>":38710}}}](http://139.196.140.118:8080/get/{"[]":{"count":3,"User":{"friendIdList<\>":38710}}})，查询friendIdList包含38710的一个User数组
