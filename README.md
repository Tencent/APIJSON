...
------------ | ------------ | ------------
 ...
 &, \|, ! 逻辑运算符。<br />& 可用于"key&{}":"条件"等。<br />\| 可用于"key\|{}":"条件", "key\|{}":[]等。<br />! 可单独使用，如"key!":Object，也可像&,\|一样配合其他功能符使用等。 | 逻辑运算 | ["id&{}":">80000,<=90000"](http://192.168.1.106:8080/head/{"User":{"id&{}":">80000,<=90000"}})，即id满足id>80000 & id<=90000。<br />["id|{}":">80000,<=90000"](http://192.168.1.106:8080/head/{"User":{"id|{}":">80000,<=90000"}})，同"id{}":">80000,<=90000"，即id满足id>80000 \| id<=90000。<br />["id!{}":[82001,38710]](http://192.168.1.106:8080/head/{"User":{"id!{}":[82001,38710]}})，即id满足 ! (id=82001 \| id=38710)，可过滤黑名单的消息。
