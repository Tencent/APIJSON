...
------------ | ------------ | ------------
 ...
 "key$":"SQL搜索表达式"  =>  "key$":["SQL搜索表达式"]，任意SQL搜索表达式字符串，如 %key%, %k%e%y% 等 | 模糊搜索 | [{"[]":{"User":{"name$":"%m%"}}}](http://139.196.140.118:8080/get/{"[]":{"count":3,"User":{"name$":"%2525m%2525"}}})，查询name包含"m"的一个User数组
