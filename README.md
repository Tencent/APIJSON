...
------------ | ------------ | ------------
 ...
 "key{}":"条件0,条件1..."，条件为任意SQL比较字符串，非Number类型必须用''包含条件的值，如'a' | 匹配条件范围 | "id{}":">=80000,\<=100000"，查询id在80000,100000中任意一个的Object。一般用于查询一个数组。请求[{"[]":{"User":{"id{}":">=80000,\<=100000"}}}](http://139.196.140.118:8080/get/{"[]":{"count":3,"User":{"id{}":">=80000,\<=100000"}}})会返回一个User数组，例如上面那个。
