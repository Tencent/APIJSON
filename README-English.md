...
GETS: <br > safe, single, simple GET | base_url/post_get/ | 最外层加一个"tag":tag，其它同GET | 同GET
HEADS: <br > safe, single, simple HEAD | base_url/post_head/ | 最外层加一个"tag":tag，其它同HEAD | 同HEAD
